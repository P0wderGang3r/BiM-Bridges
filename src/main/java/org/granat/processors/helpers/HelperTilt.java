...
public class HelperTilt implements IHelper {
    ...
    public Map<String, Object> run(Supplier<Stream<Point>> ignored, Map<String, Double> matrix) {
        ...
        //Далее проходимся по всей карте изменений высот
        //Если перепад до точки значительный, т.е. больше среднего абсолютного отклонения, то бракуем такой перепад
        //Если точка находится ниже или на той же высоте, что и точка, которая была отбракована, то бракуем данную точку
